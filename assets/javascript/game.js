var words = ["ZELDA", "LINK", "HYRULE", "TRIFORCE", "GANON", "FAIRY", "DEKU", "BOOMERANG", "HOOKSHOT", "BOW", 
"MASTERSWORD", "BOMB", "GORON", "CUCCO", "EPONA", "OCARINA", "RUPEE", "POTION", "BOOTS", "KOKIRI", "HEART",
 "KOKIRI", "NAVI", "SHIELD", "TEMPLE", "SKULLTULA", "MEDALLION", "MASK"];
...
document.onkeyup = function (event) {
    ...
    for (var j = 0; j < currentWord.length; j++) {
        ...
        else if (currentWord.indexOf(userInput) == -1 && incorrectGuesses.indexOf(userInput) == -1 && lossCondition 
        == false && winCondition == false && search.test(userInput) == true) {
